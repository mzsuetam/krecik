...
class KrecikListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by KrecikParser#for_instruction.
    def enterFor_instruction(self, ctx:KrecikParser.For_instructionContext):
        pass

    # Exit a parse tree produced by KrecikParser#for_instruction.
    def exitFor_instruction(self, ctx:KrecikParser.For_instructionContext):
        pass
    ...
    # Enter a parse tree produced by KrecikParser#update_statement.
    def enterUpdate_statement(self, ctx:KrecikParser.Update_statementContext):
        pass

    # Exit a parse tree produced by KrecikParser#update_statement.
    def exitUpdate_statement(self, ctx:KrecikParser.Update_statementContext):
        pass
