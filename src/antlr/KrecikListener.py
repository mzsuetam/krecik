...
class KrecikListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by KrecikParser#product.
    def enterProduct(self, ctx:KrecikParser.ProductContext):
        pass

    # Exit a parse tree produced by KrecikParser#product.
    def exitProduct(self, ctx:KrecikParser.ProductContext):
        pass
